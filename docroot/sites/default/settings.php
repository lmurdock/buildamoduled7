...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_magnifascentwebny_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_magnifascentwebny_dev_default.inc';
}
// </DDSETTINGS>
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/magnifascentwebny/magnifascentwebny-settings.inc');
}
